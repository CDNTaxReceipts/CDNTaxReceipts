...
class CRM_Cdntaxreceipts_PDFGeneratorOriginal extends CRM_Cdntaxreceipts_PDFGenerator {
  ...
  function open() {
    ...
    $this->pdf = new CRM_Cdntaxreceipts_PdfFpdi(PDF_PAGE_ORIENTATION, PDF_UNIT, 'LETTER', TRUE, 'UTF-8', FALSE);
    $this->pdf->Open();
