...
Earlier versions of this Extension required a permission -> CiviCRM CDN Tax Receipts: Open Tracking
That's no longer required - but make sure that $openTracking parameter is in the message template!
